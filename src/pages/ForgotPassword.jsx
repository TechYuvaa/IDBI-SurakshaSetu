  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center py-10 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-6 z-10">
        ...
        {process.env.NODE_ENV !== 'production' && demoOtp && step === 2 && (
          <motion.div 
          ...
          >
            <div className="absolute top-0 right-0 p-1 bg-brand-primary/10 rounded-bl text-[8px] font-mono tracking-widest text-brand-primary font-bold">DEV_RECOVERY</div>
